...
- Should I make a class for each unit? With properties for the singular name, the plural name, and the symbol? The properties could be lists that can hold multiple values to handle cases like meter/metre.
